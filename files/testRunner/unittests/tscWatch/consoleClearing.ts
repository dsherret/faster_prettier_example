namespace ts.tscWatch {
  describe("unittests:: tsc-watch:: console clearing", () => {
    ...
    checkConsoleClearingUsingCommandLineOptions("with --extendedDiagnostics", [
      "--extendedDiagnostics",
    ]);
    checkConsoleClearingUsingCommandLineOptions("with --preserveWatchOutput", [
      "--preserveWatchOutput",
    ]);
