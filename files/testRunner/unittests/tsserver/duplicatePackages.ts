namespace ts.projectSystem {
  describe("unittests:: tsserver:: duplicate packages", () => {
    ...
    it("works with import fixes", () => {
      ...
      const aFooIndex: File = {
        path: "/a/node_modules/foo/index.d.ts",
        content: packageContent,
      };
      const aFooPackage: File = {
        path: "/a/node_modules/foo/package.json",
        content: packageJsonContent,
      };
      const bFooIndex: File = {
        path: "/b/node_modules/foo/index.d.ts",
        content: packageContent,
      };
      const bFooPackage: File = {
        path: "/b/node_modules/foo/package.json",
        content: packageJsonContent,
      };
