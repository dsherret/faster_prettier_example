      ...
      assert.deepEqual<readonly protocol.FileCodeEdits[]>(response, [
        {
          ...
          textChanges: [
            {
              ...protocolTextSpanFromSubstring(aTsconfig.content, "./old.ts"),
              newText: "new.ts",
            },
          ],
        },
        {
          ...
          textChanges: [
            {
              ...protocolTextSpanFromSubstring(aUserTs.content, "./old"),
              newText: "./new",
            },
          ],
        },
        {
          ...
          textChanges: [
            {
              ...protocolTextSpanFromSubstring(bUserTs.content, "../a/old"),
              newText: "../a/new",
            },
          ],
        },
      ...
      assert.deepEqual<readonly protocol.FileCodeEdits[]>(response, [
        {
          ...
          textChanges: [
            {
              ...protocolTextSpanFromSubstring(tsconfig.content, "./b.ts"),
              newText: "c.ts",
            },
          ],
        },
        {
          ...
          textChanges: [
            {
              ...protocolTextSpanFromSubstring(aTs.content, "./b"),
              newText: "./c",
            },
          ],
        },
