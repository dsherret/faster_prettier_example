namespace ts {
  describe("unittests:: TransformAPI", () => {
    ...
    testBaseline("substitution", () => {
      return transformSourceFile(`var a = undefined;`, [
        replaceUndefinedWithVoid0,
      ]);
    });
        ...
        return (sourceFile: SourceFile): SourceFile => {
          ...
          function visitNode<T extends Node>(node: T): T {
            if (node.kind === SyntaxKind.ExportDeclaration) {
              ...
              const newEd = factory.updateExportDeclaration(
                ed,
                ed.decorators,
                ed.modifiers,
                ed.isTypeOnly,
          ...
          const classDecl = factory.createClassDeclaration(
            ...
            [
              factory.createMethodDeclaration(
                [factory.createDecorator(factory.createIdentifier("Bar"))],
                [],
                /**/ undefined,
                "baz",
                /**/ undefined,
              ...
              factory.createConstructorDeclaration(
                ...
                [
                  factory.createParameterDeclaration(
                    /*decorators*/ [
                      factory.createDecorator(factory.createIdentifier("Dec")),
                    ],
                    /*modifiers*/ [
...
`,
    ...
    testBaseline(
      "transformSyntheticCommentOnStaticFieldInClassDeclaration",
      () => {
        return transpileModule(
          `
