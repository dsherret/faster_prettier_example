namespace ts {
  describe("unittests:: tsc:: declarationEmit::", () => {
    ...
    function verifyDeclarationEmit({
      ...
      files,
      rootProject,
      changeCaseFileTestPath,
    }: VerifyDeclarationEmitInput) {
      describe(subScenario, () => {
        tscWatch.verifyTscWatch({
          scenario: "declarationEmit",
          subScenario,
          sys: () =>
            tscWatch.createWatchedSystem(files, {
    ...
    describe("with symlinks in sibling folders and common package referenced from both folders", () => {
      ...
      verifyDeclarationEmit({
        ...
        files: [
          {
            path: `${tscWatch.projectRoot}/plugin-two/index.d.ts`,
            content: pluginTwoDts(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-two/node_modules/typescript-fsa/package.json`,
            content: fsaPackageJson(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-two/node_modules/typescript-fsa/index.d.ts`,
            content: fsaIndex(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-one/tsconfig.json`,
            content: pluginOneConfig(),
          },
          {
          ...
          {
            path: `${tscWatch.projectRoot}/plugin-one/action.ts`,
            content: pluginOneAction(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-one/node_modules/typescript-fsa/package.json`,
            content: fsaPackageJson(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-one/node_modules/typescript-fsa/index.d.ts`,
            content: fsaIndex(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-one/node_modules/plugin-two`,
            symLink: `${tscWatch.projectRoot}/plugin-two`,
          },
          tscWatch.libFile,
        ],
      ...
      verifyDeclarationEmit({
        ...
        files: [
          ...
          {
            path: `${tscWatch.projectRoot}/plugin-two/dist/commonjs/index.d.ts`,
            content: pluginTwoDts(),
          },
          {
            path: `${tscWatch.projectRoot}/plugin-two/node_modules/typescript-fsa/package.json`,
...
${pluginOneAction()}`,
          ...
          {
            path: `/temp/yarn/data/link/plugin-two`,
            symLink: `${tscWatch.projectRoot}/plugin-two`,
          },
          {
            path: `${tscWatch.projectRoot}/plugin-one/node_modules/plugin-two`,
