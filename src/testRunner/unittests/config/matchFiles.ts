namespace ts {
  ...
  function validateMatches(
  ...
  ) {
    {
      ...
      const actual = parseJsonSourceFileConfigFileContent(
        result,
        host,
        basePath,
        existingOptions,
    ...
    {
      const actual = parseJsonConfigFileContent(
        json,
        host,
        basePath,
        existingOptions,
  ...
  function createDiagnosticForConfigFile(
    json: any,
    start: number,
    length: number,
  ...
  describe("unittests:: config:: matchFiles", () => {
    it("with defaults", () => {
      ...
      const expected: ParsedCommandLine = {
        options: {},
        errors: [],
        fileNames: ["c:/dev/a.ts", "c:/dev/b.ts", "c:/dev/x/a.ts"],
        wildcardDirectories: {
    ...
    describe("with literal include list", () => {
      ...
      it("with wildcard excludes", () => {
        const json = {
          include: ["a.ts", "b.ts", "z/a.ts", "z/abz.ts", "z/aba.ts", "x/b.ts"],
          exclude: ["*.ts", "z/??z.ts", "*/b.ts"],
        };
        const expected: ParsedCommandLine = {
          options: {},
          errors: [],
      ...
      it("with recursive excludes", () => {
        const json = {
          include: ["a.ts", "b.ts", "x/a.ts", "x/b.ts", "x/y/a.ts", "x/y/b.ts"],
          exclude: ["**/b.ts"],
        };
        const expected: ParsedCommandLine = {
          options: {},
    ...
    describe("with wildcard include list", () => {
      ...
      it("with multiple recursive directories", () => {
        const json = {
          include: ["x/y/**/a.ts", "x/**/a.ts", "z/**/a.ts"],
        };
        const expected: ParsedCommandLine = {
          options: {},
          errors: [],
          fileNames: ["c:/dev/x/y/a.ts", "c:/dev/x/a.ts", "c:/dev/z/a.ts"],
          wildcardDirectories: {
      ...
      describe("with common package folders", () => {
        it("and no exclusions", () => {
          ...
          const expected: ParsedCommandLine = {
            options: {},
            errors: [],
            fileNames: ["c:/dev/a.ts", "c:/dev/x/a.ts"],
            wildcardDirectories: {
              "c:/dev": WatchDirectoryFlags.Recursive,
            },
          };
        ...
        it("and exclusions", () => {
          ...
          const expected: ParsedCommandLine = {
            options: {},
            errors: [],
            fileNames: ["c:/dev/b.ts", "c:/dev/x/a.ts"],
            wildcardDirectories: {
              "c:/dev": WatchDirectoryFlags.Recursive,
            },
          };
        ...
        it("and explicit recursive include", () => {
          const json = {
            include: ["**/a.ts", "**/node_modules/a.ts"],
          };
          const expected: ParsedCommandLine = {
            options: {},
            errors: [],
        ...
        it("and explicit wildcard include", () => {
          ...
          const expected: ParsedCommandLine = {
            options: {},
            errors: [],
            fileNames: ["c:/dev/x/a.ts", "c:/dev/node_modules/a.ts"],
            wildcardDirectories: {
              "c:/dev": WatchDirectoryFlags.Recursive,
            },
          };
      ...
      it("include explicitly listed .min.js files when allowJs=true", () => {
        ...
        const expected: ParsedCommandLine = {
          ...
          errors: [],
          fileNames: ["c:/dev/js/ab.min.js", "c:/dev/js/d.min.js"],
          wildcardDirectories: {
            "c:/dev/js": WatchDirectoryFlags.None,
          },
        };
      ...
      it("include files with .. in their name", () => {
        const json = {
          include: ["c:/ext/b/a..b.ts"],
          exclude: ["**"],
        };
        const expected: ParsedCommandLine = {
          options: {},
          errors: [],
          fileNames: ["c:/ext/b/a..b.ts"],
          wildcardDirectories: {},
        };
        validateMatches(
          expected,
      ...
      it("with jsx=none, allowJs=false", () => {
        ...
        const expected: ParsedCommandLine = {
          ...
          errors: [],
          fileNames: ["c:/dev/a.ts", "c:/dev/b.tsx", "c:/dev/c.tsx"],
          wildcardDirectories: {
            "c:/dev": WatchDirectoryFlags.Recursive,
          },
        };
      ...
      describe("with multiple recursive directory patterns", () => {
        ...
        it("in excludes", () => {
          ...
          const expected: ParsedCommandLine = {
            options: {},
            errors: [],
            fileNames: ["c:/dev/a.ts", "c:/dev/z/a.ts"],
            wildcardDirectories: {
              "c:/dev": WatchDirectoryFlags.Recursive,
            },
          };
    ...
    describe("with files or folders that begin with a .", () => {
      it("that are not explicitly included", () => {
        ...
        const expected: ParsedCommandLine = {
          options: {},
          errors: [],
          fileNames: ["c:/dev/x/d.ts", "c:/dev/x/y/d.ts"],
          wildcardDirectories: {
            "c:/dev/x": WatchDirectoryFlags.Recursive,
      ...
      describe("that are explicitly included", () => {
        it("without wildcards", () => {
          const json = {
            include: ["x/.y/a.ts", "c:/dev/.z/.b.ts"],
          };
          const expected: ParsedCommandLine = {
            options: {},
            errors: [],
            fileNames: ["c:/dev/x/.y/a.ts", "c:/dev/.z/.b.ts"],
            wildcardDirectories: {},
          };
          validateMatches(
            expected,
