  ...
  describe("unittests:: tsc-watch:: Emit times and Error updates in builder after program changes", () => {
    ...
    function verifyEmitAndErrorUpdatesWorker({
      ...
      verifyTscWatch({
        ...
        commandLineArgs: ["--w"],
        sys: () =>
          createWatchedSystem([...files(), configFile(), lib?.() || libFile], {
...
export class Data2 {
    public dat?: Data;
        ...
        verifyTransitiveExports("yes circular import/exports", [
          lib2Data,
          lib2Data2,
        ]);
      });
    ...
    describe("with noEmitOnError", () => {
      ...
      verifyEmitAndErrorUpdates({
        ...
        files: () =>
          ["shared/types/db.ts", "src/main.ts", "src/other.ts"].map((f) =>
