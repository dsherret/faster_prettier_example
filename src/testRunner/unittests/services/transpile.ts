  ...
  describe("unittests:: services:: Transpile", () => {
    ...
    function transpilesCorrectly(
      ...
      describe(name, () => {
        ...
        if (!unitName) {
          unitName = transpileOptions.compilerOptions.jsx
            ? "file.tsx"
            : "file.ts";
    ...
    transpilesCorrectly(
      "Generates no diagnostics with valid inputs",
      `var x = 0;`,
      {
...
var x = 0;`,
    ...
    transpilesCorrectly(
      "Generates no diagnostics for missing module imports",
    ...
    transpilesCorrectly(
      "Does not generate semantic diagnostics",
      `var x: string = 0;`,
      {
        options: { compilerOptions: { module: ModuleKind.CommonJS } },
      }
    ...
    transpilesCorrectly(
      "No extra errors for file without extension",
      `"use strict";\r\nvar x = 0;`,
      {
        options: {
    ...
    transpilesCorrectly(
      "transpile file as 'tsx' if 'jsx' is specified",
      `var x = <div/>`,
      {
        options: {
          compilerOptions: {
    ...
    transpilesCorrectly(
      "Accepts string as enum values for compile-options",
      "export const x = 0",
      {
        options: {
          compilerOptions: {
    ...
    transpilesCorrectly(
      "Report an error when compiler-options module-kind is out-of-range",
      "",
      {
    ...
    transpilesCorrectly(
      "Report an error when compiler-options target-script is out-of-range",
      "",
      {
        options: { compilerOptions: { module: 123 as any as ModuleKind } },
      }
    ...
    transpilesCorrectly("Support options with lib values", "const a = 10;", {
      options: {
        compilerOptions: { lib: ["es6", "dom"], module: ModuleKind.CommonJS },
        fileName: "input.js",
        reportDiagnostics: true,
      },
    });
    ...
    transpilesCorrectly(
      "Supports setting 'allowSyntheticDefaultImports'",
      "x;",
      {
        options: {
    ...
    transpilesCorrectly("Supports setting 'baseUrl'", "x;", {
      options: {
        compilerOptions: { baseUrl: "./folder/baseUrl" },
        fileName: "input.js",
        reportDiagnostics: true,
      },
    });
    ...
    transpilesCorrectly(
      "Supports setting 'forceConsistentCasingInFileNames'",
      "x;",
      {
        options: {
    ...
    transpilesCorrectly(
      "Supports setting 'suppressImplicitAnyIndexErrors'",
      "x;",
      {
        options: {
    ...
    transpilesCorrectly("Supports setting 'types'", "x;", {
      options: {
        compilerOptions: { types: ["jquery", "jasmine"] },
        fileName: "input.js",
        reportDiagnostics: true,
      },
    });
    ...
    transpilesCorrectly("Supports setting 'typeRoots'", "x;", {
      options: {
        compilerOptions: { typeRoots: ["./folder"] },
        fileName: "input.js",
        reportDiagnostics: true,
      },
    });
    ...
    transpilesCorrectly("Supports setting 'tsbuildinfo'", "x;", {
      options: {
        compilerOptions: {
          incremental: true,
          tsBuildInfoFile: "./folder/config.tsbuildinfo",
        },
        fileName: "input.js",
        reportDiagnostics: true,
      },
    ...
    transpilesCorrectly(
      "Supports readonly keyword for arrays",
