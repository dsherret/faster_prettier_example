  ...
  describe("Test preProcessFiles,", () => {
    ...
    it("Correctly return referenced files and import files", () => {
      test(
        ...
        {
          referencedFiles: [
            { fileName: "refFile1.ts", pos: 20, end: 31 },
            { fileName: "refFile2.ts", pos: 57, end: 68 },
          ],
          typeReferenceDirectives: [],
          libReferenceDirectives: [],
          importedFiles: [
            { fileName: "r1.ts", pos: 92, end: 97 },
            { fileName: "r2.ts", pos: 121, end: 126 },
          ],
          ambientExternalModules: undefined,
          isLibFile: false,
        }
    ...
    it("Correctly return referenced files and import files even with some invalid syntax", () => {
      test(
        ...
        /*detectJavaScriptImports*/ false,
        {
          ...
          libReferenceDirectives: [],
          importedFiles: [
            { fileName: "r1.ts", pos: 91, end: 96 },
            { fileName: "r3.ts", pos: 148, end: 153 },
          ],
          ambientExternalModules: undefined,
          isLibFile: false,
        }
