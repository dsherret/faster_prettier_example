namespace ts.projectSystem {
  describe("unittests:: tsserver:: refactors", () => {
    ...
    it("handles canonicalization of tsconfig path", () => {
      ...
      const result = executeSessionRequest<
        protocol.GetEditsForRefactorRequest,
        protocol.GetEditsForRefactorResponse
      >(session, protocol.CommandTypes.GetEditsForRefactor, {
        file: aTs.path,
        startLine: 1,
        startOffset: 1,
        endLine: 2,
        ...
        edits: [
          {
            ...
            textChanges: [
              {
                start: { line: 1, offset: 1 },
                end: { line: 1, offset: aTs.content.length + 1 },
                newText: "",
              },
            ],
          },
