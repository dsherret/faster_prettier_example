namespace ts.projectSystem {
  function setup(fileName: string, content: string) {
    ...
    return function getSmartSelectionRange(
      ...
      return executeSessionRequest<
        ...
        protocol.SelectionRangeResponse
      >(session, CommandNames.SelectionRange, { file: fileName, locations });
    };
  }
  ...
  describe("unittests:: tsserver:: smartSelection", () => {
    it("works for simple JavaScript", () => {
      const getSmartSelectionRange = setup(
        "/file.js",
        `
class Foo {
    bar(a, b) {
      ...
      assert.deepEqual(locations, [
        {
          ...
          parent: {
            ...
            parent: {
              ...
              parent: {
                textSpan: {
                  // SyntaxList + whitespace (body of method)
                ...
                parent: {
                  ...
                  parent: {
                    textSpan: {
                      // SyntaxList + whitespace (body of class)
