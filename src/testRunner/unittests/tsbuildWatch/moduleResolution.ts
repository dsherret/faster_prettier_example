    ...
    verifyTscWatch({
      ...
      sys: () =>
        createWatchedSystem(
          [
            {
              path: `${projectRoot}/project1/index.ts`,
              content: `import { foo } from "file";`,
            },
            {
              path: `${projectRoot}/project1/node_modules/file/index.d.ts`,
            ...
            {
              path: `${projectRoot}/project2/index.ts`,
              content: `import { foo } from "file";`,
            },
            {
              path: `${projectRoot}/project2/file.d.ts`,
              content: "export const foo = 10;",
            },
            {
            ...
            {
              path: `${projectRoot}/node_modules/@types/foo/index.d.ts`,
              content: "export const foo = 10;",
            },
            {
              path: `${projectRoot}/node_modules/@types/bar/index.d.ts`,
