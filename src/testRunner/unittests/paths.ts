describe("unittests:: core paths", () => {
  ...
  it("getPathComponents", () => {
    ...
    assert.deepEqual(ts.getPathComponents("//server/"), ["//server/"]);
    assert.deepEqual(ts.getPathComponents("//server/share"), [
      "//server/",
      "share",
    ]);
    assert.deepEqual(ts.getPathComponents("file:///"), ["file:///"]);
    assert.deepEqual(ts.getPathComponents("file:///path"), [
      "file:///",
      "path",
    ]);
    ...
    assert.deepEqual(ts.getPathComponents("file:///c:/"), ["file:///c:/"]);
    assert.deepEqual(ts.getPathComponents("file:///c:/path"), [
      "file:///c:/",
      "path",
    ]);
    assert.deepEqual(ts.getPathComponents("file://server"), ["file://server"]);
    assert.deepEqual(ts.getPathComponents("file://server/"), [
      "file://server/",
    ]);
    assert.deepEqual(ts.getPathComponents("file://server/path"), [
      "file://server/",
      "path",
    ]);
    assert.deepEqual(ts.getPathComponents("http://server"), ["http://server"]);
    assert.deepEqual(ts.getPathComponents("http://server/"), [
      "http://server/",
    ]);
    assert.deepEqual(ts.getPathComponents("http://server/path"), [
      "http://server/",
      "path",
    ]);
  });
