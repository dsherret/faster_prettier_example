...
namespace ts.codefix {
  ...
  registerCodeFix({
    ...
    getCodeActions(context) {
      ...
      const changeToExpression = textChanges.ChangeTracker.with(context, (t) =>
        doChange(
          t,
          preferences,
          sourceFile,
    ...
    getAllCodeActions(context) {
      return codeFixAll(context, errorCodes, (changes, diagnostic) =>
        doChange(
          changes,
          context.preferences,
          diagnostic.file,
  ...
  function doChange(
    ...
    const replacement = useHtmlEntity
      ...
      : `{${quote(sourceFile, preferences, character)}}`;
