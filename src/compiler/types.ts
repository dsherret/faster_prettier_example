namespace ts {
  ...
  export interface StringLiteral extends LiteralExpression, Declaration {
    ...
    /* @internal */ readonly textSourceNode?:
      | Identifier
      | StringLiteralLike
      | NumericLiteral; // Allows a StringLiteral to get its text from another node (used by transforms).
  ...
  export interface SourceFile extends Declaration {
    ...
    /* @internal */ resolvedModules?: ModeAwareCache<
    ...
    /* @internal */ moduleAugmentations: readonly (
      | StringLiteral
      | Identifier
    )[];
  ...
  export interface TypeCheckerHost extends ModuleSpecifierResolutionHost {
    ...
    getSourceFiles(): readonly SourceFile[];
    getSourceFile(fileName: string): SourceFile | undefined;
    getResolvedTypeReferenceDirectives(): ModeAwareCache<
      ResolvedTypeReferenceDirective | undefined
    >;
  ...
  /* @internal */
  export type AnyImportOrRequire =
    | AnyImportSyntax
    | VariableDeclarationInitializedTo<RequireOrImportCall>;

  /* @internal */
  export type AnyImportOrRequireStatement =
    | AnyImportSyntax
  ...
  export interface NodeLinks {
    ...
    serializedTypes?: ESMap<
      string,
      TypeNode & { truncating?: boolean; addedLength: number }
  ...
  export interface CommandLineOptionBase {
    ...
    type:
      ...
      | "object"
      | "list"
      | ESMap<string, number | string>; // a value of a primitive type, or an object literal mapping named values to actual values
  ...
  export interface NodeFactory {
     ...
     * @param allowSourceMaps A value indicating whether source maps may be emitted for the name.
     */
    /* @internal */ getNamespaceMemberName(
      ns: Identifier,
      name: Identifier,
      allowComments?: boolean,
      allowSourceMaps?: boolean,
     ...
     * @param allowSourceMaps A value indicating whether source maps may be emitted for the name.
     */
    /* @internal */ getExternalModuleOrNamespaceExportName(
